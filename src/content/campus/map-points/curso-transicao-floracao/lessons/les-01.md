# 12/12 como promessa e disciplina
...
**Área do mapa:** Transição floração  
**Aula 1/5**

## Gancho
12/12 como promessa e disciplina aparece aqui como frente cinematográfica do seu caderno técnico: imagine um plano‑médio na planta e um plano‑detalhe na folha que você está observando. Sem pressa, sem slogan.
...
Este marcador do mapa aprofunda **transição vegetativo → floração e gestão do ‘stretch’** dentro da trilha de cultivo indoor.
...
## Fecho
Avance quando conseguir explicar em voz alta *por que* esta aula existe dentro de **Transição floração**, não só *o que* ela lista.

...
**Módulo 2/4 · "Cannabis é proibida… e agora?"**
...
Escreva 12–15 linhas no formato **hipótese → evidência observada → próximo teste seguro** para o tema "Casos típicos". Anexe data e condições ambientais se aplicável.

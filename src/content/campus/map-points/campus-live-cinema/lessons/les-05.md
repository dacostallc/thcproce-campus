# Feedback construtivo aos realizadores campus
...
**Área do mapa:** Cinema & ao vivo  
**Aula 5/5**

## Gancho
Feedback construtivo aos realizadores campus aparece aqui como frente cinematográfica do seu caderno técnico: imagine um plano‑médio na planta e um plano‑detalhe na folha que você está observando. Sem pressa, sem slogan.
...
Este espaço do campus (Cinema & ao vivo) organiza experiência e comunidade. Mantemos tom profissional: respeito, pontualidade em eventos e orientação clara quando houver transmissão ao vivo.
...
## Fecho
Avance quando conseguir explicar em voz alta *por que* esta aula existe dentro de **Cinema & ao vivo**, não só *o que* ela lista.

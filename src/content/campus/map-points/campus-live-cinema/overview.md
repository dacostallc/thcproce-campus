...
moduleTitles:
  - Formato cinema
  - Qualidade técnica doméstica
  - Discussão pós-sessão
  - Integração futura com LMS
lessonTitles:
  - Áudio decente > resolução máxima
  - Sem spoilers tóxicos
  - Notas durante exibição
  - Créditos também contam
  - Feedback construtivo aos realizadores campus
contentVersion: 1
locale: pt-BR
---

# Cinema & transmissões ao vivo no campus
...
Auscultadores decentes, tecla de pausa, bloco de notas digital ou papel.

# Registrar temperatura em três alturas
...
**Área do mapa:** Cultivo em estufa  
**Aula 4/5**

## Gancho
Registrar temperatura em três alturas aparece aqui como frente cinematográfica do seu caderno técnico: imagine um plano‑médio na planta e um plano‑detalhe na folha que você está observando. Sem pressa, sem slogan.
...
## Fecho
Avance quando conseguir explicar em voz alta *por que* esta aula existe dentro de **Cultivo em estufa**, não só *o que* ela lista.

...
**Módulo 3/4 · Hashmaker · solventless**
...
Escreva 12–15 linhas no formato **hipótese → evidência observada → próximo teste seguro** para o tema "Prensagem responsável". Anexe data e condições ambientais se aplicável.

...
**Módulo 3/4 · Melado & carbo rápido**
...
Escreva 12–15 linhas no formato **hipótese → evidência observada → próximo teste seguro** para o tema "Sinergias". Anexe data e condições ambientais se aplicável.

...
**Área do mapa:** Aplicações terapêuticas  
**Aula 3/5**

## Gancho
Interações: lista de conversa aparece aqui como frente cinematográfica do seu caderno técnico: imagine um plano‑médio na planta e um plano‑detalhe na folha que você está observando. Sem pressa, sem slogan.
...
## Fecho
Avance quando conseguir explicar em voz alta *por que* esta aula existe dentro de **Aplicações terapêuticas**, não só *o que* ela lista.

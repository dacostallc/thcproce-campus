...
**Módulo 1/4 · Podas & clones**

## Núcleo narrativo
Este marcador do mapa aprofunda **podas de formação e clones em ambiente indoor** dentro da trilha de cultivo indoor.
...
Escreva 12–15 linhas no formato **hipótese → evidência observada → próximo teste seguro** para o tema "Por que podar". Anexe data e condições ambientais se aplicável.

...
**Módulo 1/4 · Culinária cannábica**
...
Escreva 12–15 linhas no formato **hipótese → evidência observada → próximo teste seguro** para o tema "Gastronomia primeiro". Anexe data e condições ambientais se aplicável.

...
**Módulo 2/4 · Quando usar adubo foliar**
...
Escreva 12–15 linhas no formato **hipótese → evidência observada → próximo teste seguro** para o tema "Janelas seguras". Anexe data e condições ambientais se aplicável.

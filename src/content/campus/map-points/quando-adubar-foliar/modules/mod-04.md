...
**Módulo 4/4 · Quando usar adubo foliar**

## Integração
Foliar é pontuação musical — não tapete contínuo.

### Ponte com Quando usar adubo foliar
...
Escreva 12–15 linhas no formato **hipótese → evidência observada → próximo teste seguro** para o tema "Stop rules". Anexe data e condições ambientais se aplicável.

...
**Módulo 1/4 · Extração de óleo**

## Núcleo narrativo
óleos, tinturas e disciplina de laboratório doméstico autorizado. Abordamos higiene, padronização aproximada e linguagem responsável sobre dosagens — sem rotular produtos caseiros como medicamentos registrados.
...
Escreva 12–15 linhas no formato **hipótese → evidência observada → próximo teste seguro** para o tema "Fundamentos lipídicos". Anexe data e condições ambientais se aplicável.

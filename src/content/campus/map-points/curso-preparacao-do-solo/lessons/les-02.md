...
**Área do mapa:** Preparação do solo  
**Aula 2/5**

## Gancho
Composto maduro versus fresco aparece aqui como frente cinematográfica do seu caderno técnico: imagine um plano‑médio na planta e um plano‑detalhe na folha que você está observando. Sem pressa, sem slogan.
...
Análise simples: textura, infiltração; correções com compostagem madura; mulch;
...
## Fecho
Avance quando conseguir explicar em voz alta *por que* esta aula existe dentro de **Preparação do solo**, não só *o que* ela lista.

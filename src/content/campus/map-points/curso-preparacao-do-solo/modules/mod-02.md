...
Escreva 12–15 linhas no formato **hipótese → evidência observada → próximo teste seguro** para o tema "Correções lentas". Anexe data e condições ambientais se aplicável.

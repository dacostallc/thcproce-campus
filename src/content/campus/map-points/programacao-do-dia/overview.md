---
mapPointId: "programacao-do-dia"
title: "Programação do dia"
panelTitle: "Programação do dia"
linkedCourseId: ""
shortDescription: "Programação do dia"
longDescription: "agenda diária do campus. Trilha textual preparada para LMS, portal web e futuras peças audiovisuais — prioriza método, segurança e clareza jurídico‑sanitária."
introduction: "Este espaço do campus (Programação do dia) organiza experiência e comunidade. Mantemos tom profissional: respeito, pontualidade em eventos e orientação clara quando houver transmissão ao vivo."
objectives:
...
lessonTitles:
  - "Fuso horário BR"
  - "Check-in antes da live"
  - "Perguntas objetivas"
  - "Respeitar monitores"
  - "Salvar links oficiais"
contentVersion: 1
locale: "pt-BR"
---
...
Este espaço do campus (Programação do dia) organiza experiência e comunidade. Mantemos tom profissional: respeito, pontualidade em eventos e orientação clara quando houver transmissão ao vivo.

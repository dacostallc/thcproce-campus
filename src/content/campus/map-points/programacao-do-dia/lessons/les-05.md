...
**Área do mapa:** Programação do dia  
**Aula 5/5**

## Gancho
Salvar links oficiais aparece aqui como frente cinematográfica do seu caderno técnico: imagine um plano‑médio na planta e um plano‑detalhe na folha que você está observando. Sem pressa, sem slogan.
...
## Fecho
Avance quando conseguir explicar em voz alta *por que* esta aula existe dentro de **Programação do dia**, não só *o que* ela lista.

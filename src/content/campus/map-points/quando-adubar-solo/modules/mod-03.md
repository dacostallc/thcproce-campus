...
**Módulo 3/4 · Quando fertilizar solo vivo**
...
Escreva 12–15 linhas no formato **hipótese → evidência observada → próximo teste seguro** para o tema "Janelas sazonais". Anexe data e condições ambientais se aplicável.

...
**Módulo 3/4 · Nutrientes & soluções**
...
Escreva 12–15 linhas no formato **hipótese → evidência observada → próximo teste seguro** para o tema "Diagnóstico foliar". Anexe data e condições ambientais se aplicável.

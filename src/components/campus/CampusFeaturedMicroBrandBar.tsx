...
type Props = {
  className?: string;
  /** Índice da aula atual — na primeira (0) usa subtítulo de boas-vindas em vez do tagline longo. */
  lessonIndex?: number;
};
...
export function CampusFeaturedMicroBrandBar({ className, lessonIndex }: Props) {
  ...
  const theme = getCourseLessonTheme(CANNABIS101_AREA_ID);
  const subtitle =

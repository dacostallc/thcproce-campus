...
export const CAMPUS_BIOME_LAYERS: CampusBiomeLayer[] = [
  {
    ...
    rx: 18,
    ry: 26,
    night: "rgba(34,197,94,0.055)",
    day: "rgba(22,163,74,0.04)"
  },
  {
    cx: 46,
    cy: 18,
    rx: 14,
    ry: 12,
    night: "rgba(34,197,94,0.045)",
    day: "rgba(22,163,74,0.032)"
  },
  {
    cx: 74,
    cy: 18,
    rx: 22,
    ry: 14,
    night: "rgba(168,85,247,0.05)",
    day: "rgba(147,51,234,0.035)"
  },
  {
    cx: 87,
    cy: 28,
    rx: 14,
    ry: 24,
    night: "rgba(56,189,248,0.05)",
    day: "rgba(6,182,212,0.035)"
  },
  {
    cx: 50,
    cy: 50,
    rx: 20,
    ry: 20,
    night: "rgba(251,191,36,0.045)",
    day: "rgba(250,204,21,0.032)"
  },
  {
    cx: 54,
    cy: 64,
    rx: 16,
    ry: 14,
    night: "rgba(230,220,205,0.04)",
    day: "rgba(148,163,184,0.028)"
  }
];

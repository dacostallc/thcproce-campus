...
const AREA_FALLBACK_ROWS: Area[] = [
  ...
  },
  {
    ...
    color: "amber",
    position: { x: 60, y: 20 },
    description: "A fase mais crítica do cultivo: como induzir e conduzir a floração, interpretar tricomas e maximizar a produção de resina.",
    highlights: ["Indução da floração com 12/12", "Leitura de tricomas para colheita", "Nutrição na fase de floração", "Ponto de colheita ideal"],
    professor: "Equipa THCProce",
    lessons: 20,
    hours: "≈8h",
  },
  {
    id: "nutricao-cannabis",
    name: "Nutrição da Cannabis",
    mapLabel: "Nutrição",
    ...
    color: "canna",
    position: { x: 35, y: 35 },
    description: "O uso eficiente de nutrientes na cannabis: NPK, pH e EC como ferramentas de diagnóstico, deficiências e toxicidades.",
    highlights: ["Macronutrientes NPK e secundários", "pH e EC como diagnóstico", "Deficiências e toxicidades", "Nutrição orgânica vs mineral"],
    professor: "Equipa THCProce",
    lessons: 27,
    hours: "≈11h",
  },
  {
    ...
    color: "canna",
    position: { x: 50, y: 30 },
    description: "Fundamentos do solo para cannabis: composição, pH ideal, microbioma, emendas orgânicas e substratos de alta drenagem.",
    highlights: ["Composição física e química do solo", "pH e microbioma", "Emendas orgânicas e compostagem", "Substratos de alta drenagem"],
    professor: "Equipa THCProce",
    lessons: 19,
    hours: "≈8h",
  },
